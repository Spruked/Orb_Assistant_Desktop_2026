...
# Desktop presence and movement profile.
# CALI owns the full virtual desktop.  Direct cursor leash mode is disabled:
# the cursor remains an availability sensor, not CALI's position target.
...
$env:ORB_MULTI_DISPLAY_PATROL_INTERVAL_MS = "18000"
$env:ORB_MULTI_DISPLAY_PATROL_SPEED_BONUS = "3.4"
$env:ORB_CURSOR_SAMPLE_MS = "33"
$env:ORB_TOPMOST_WATCHDOG_MS = "500"
$env:ORB_TOPMOST_REFRESH_MS = "3000"
$env:ORB_CURSOR_CLEARANCE_EXTRA_PX = "120"
$env:ORB_CALM_SCREEN_ANCHOR = "1"
$env:ORB_SCREEN_ANCHOR_X_RATIO = "0.54"
$env:ORB_SCREEN_ANCHOR_Y_RATIO = "0.44"
$env:ORB_CURSOR_FOLLOW = "0"
$env:ORB_CURSOR_FOLLOW_ENABLED = "0"
$env:ORB_CURSOR_ATTRACTION_STRENGTH = "0"
$env:ORB_CURSOR_ASSIST_MODE_ONLY = "1"
$env:ORB_CURSOR_AVAILABILITY_ENABLED = "1"
$env:ORB_CURSOR_AVAILABILITY_DISTANCE = "950"
$env:ORB_CURSOR_AVAILABILITY_COOLDOWN_MS = "5000"
$env:ORB_SUMMON_THRUST_MS = "6200"
$env:ORB_SUMMON_THRUST_SPEED = "7.2"
$env:ORB_SUMMON_THRUST_ACCEL = "0.48"
$env:ORB_WHISTLE_SUMMON_COOLDOWN_SEC = "4.0"
$env:ORB_WHISTLE_MIN_HZ = "1150"
$env:ORB_WHISTLE_MAX_HZ = "4200"
$env:ORB_WHISTLE_MIN_RMS = "0.018"
$env:ORB_WHISTLE_TONAL_RATIO = "0.18"
$env:ORB_WHISTLE_BAND_RATIO = "0.34"
$env:ORB_WHISTLE_HIGH_LOW_RATIO = "1.15"
